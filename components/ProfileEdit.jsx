...
export default function ProfileEdit({
  ...
  onUpdateBio,
  onUpdateProfilePic,
  onUpdateBannerImage, // New prop for banner image
  onUpdateBackgroundColor, // New prop for background color
  onClose
}) {
  ...
  return (
    <div className="content-panel profile-edit-container">
      ...
      <form onSubmit={handleSaveAll} className="profile-edit-form">
        ...
        {/* Banner Image - New section */}
        <div className="edit-section">
          <label className="form-label">Banner Image</label>
          <div className="banner-pic-edit">
            {bannerImage && (
              <div className="banner-preview" style={{ backgroundImage: `url(${bannerImage})` }}>
              </div>
            )}
            <input
              type="url"
